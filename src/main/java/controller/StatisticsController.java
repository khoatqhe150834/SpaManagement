...
public class StatisticsController extends HttpServlet {
    ...
    private void handleRevenueStatistics(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/WEB-INF/view/manager/statistics/revenue-statistics.jsp").forward(request, response);
    }
    ...
    private void handlePaymentMethodsStatistics(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/WEB-INF/view/manager/statistics/methods-statistics.jsp").forward(request, response);
    }
    ...
    private void handleTimelineStatistics(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/WEB-INF/view/manager/statistics/timeline-statistics.jsp").forward(request, response);
    }
    ...
    private void handleCustomerStatistics(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/WEB-INF/view/manager/statistics/customers-statistics.jsp").forward(request, response);
    }
    ...
    private void handleServiceStatistics(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/WEB-INF/view/manager/statistics/services-statistics.jsp").forward(request, response);
    }
}
