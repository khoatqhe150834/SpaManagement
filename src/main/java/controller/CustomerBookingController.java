...
public class CustomerBookingController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            if (servletPath.equals("/customer/bookings")) {
                ...
                } else if (pathInfo.equals("/details-test")) {
                    handleBookingDetailsTest(request, response, customer);
                } else {
    ...
    /**
     * Handle booking details test view - for debugging data loading issues
     */
    private void handleBookingDetailsTest(HttpServletRequest request, HttpServletResponse response, Customer customer)
            throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            // Set request attributes
            request.setAttribute("booking", booking);
            request.setAttribute("pageTitle", "Test Booking Details - Spa Hương Sen");

            // Forward to test page
            request.getRequestDispatcher("/WEB-INF/view/customer/booking-details-test.jsp")
                    .forward(request, response);
