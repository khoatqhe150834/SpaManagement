  ...
  --
  -- Host: 127.0.0.1    Database: spamanagement
  -- ------------------------------------------------------
  ...
  INSERT INTO `blog_categories` VALUES (1,4),(2,4),(7,4),(8,4),(9,4),(10,4),(12,4),(15,4),(16,4),(17,4),(3,5),(4,5),(5,5),(6,5),(11,5),(13,5),(14,5);
  ...
  CREATE TABLE `booking_sessions` (
    ...
    `current_step` enum('services','therapists','time','registration','payment') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'services',
  ...
  INSERT INTO `inventory_category` VALUES (1,'Hóa chất','Các loại hóa chất sử dụng trong spa',1),(2,'Dụng cụ','Dụng cụ phục vụ dịch vụ spa',1),(3,'Tiêu hao','Vật tư tiêu hao hàng ngày',1),(4,'Khác','Vật tư khác',0);
  ...
  CREATE TABLE `inventory_issue` (
    ...
    `booking_appointment_id` int DEFAULT NULL,
    ...
    KEY `booking_appointment_id` (`booking_appointment_id`),
    KEY `requested_by` (`requested_by`),
    KEY `approved_by` (`approved_by`),
    CONSTRAINT `inventory_issue_ibfk_1` FOREIGN KEY (`booking_appointment_id`) REFERENCES `booking_appointments` (`appointment_id`),
  ...
  INSERT INTO `inventory_issue` VALUES (1,'2025-06-25 08:30:00',143,5,7,'APPROVED','Xuất vật tư cho booking 143 (Massage Đá Nóng)','2025-07-14 09:18:03'),(2,'2025-06-25 14:00:00',145,5,7,'APPROVED','Xuất vật tư cho booking 145 (Manicure cơ bản)','2025-07-14 09:18:03'),(3,'2025-06-26 09:00:00',147,12,7,'APPROVED','Xuất vật tư cho booking 147 (Chăm sóc da cơ bản)','2025-07-14 09:18:03'),(4,'2025-06-27 10:00:00',NULL,7,7,'APPROVED','Xuất vật tư cho phòng xông hơi','2025-07-14 09:18:03');
  ...
  INSERT INTO `inventory_issue_detail` VALUES (1,1,1,100,'Xuất dầu massage cho booking 143'),(2,1,2,5,'Xuất khăn cho booking 143'),(3,1,5,20,'Xuất tinh dầu cho booking 143'),(4,2,2,2,'Xuất khăn cho booking 145'),(5,2,7,1,'Xuất bộ dụng cụ nail cho booking 145'),(6,3,3,2,'Xuất mặt nạ cho booking 147'),(7,3,6,1,'Xuất bông tẩy trang cho booking 147'),(8,4,5,10,'Xuất tinh dầu cho phòng xông hơi'),(9,4,8,2,'Xuất khẩu trang cho phòng xông hơi');
  ...
  INSERT INTO `inventory_item` VALUES (1,'Dầu massage lavender',1,1,'ml',5000,500,'Dầu massage hương lavender dùng cho các dịch vụ massage','2025-07-14 09:18:03','2025-07-15 13:27:23',0),(2,'Khăn spa',2,2,'cái',200,20,'Khăn cotton dùng cho khách','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(3,'Mặt nạ dưỡng da',1,1,'gói',100,10,'Mặt nạ giấy dưỡng da cho dịch vụ facial','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(4,'Găng tay y tế',3,3,'đôi',300,30,'Găng tay dùng 1 lần cho kỹ thuật viên','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(5,'Tinh dầu sả chanh',1,1,'ml',1500,100,'Tinh dầu dùng cho xông phòng','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(6,'Bông tẩy trang',3,3,'bịch',80,10,'Bông tẩy trang dùng cho facial','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(7,'Bộ dụng cụ nail',2,2,'bộ',20,5,'Bộ dụng cụ làm móng','2025-07-14 09:18:03','2025-07-14 09:18:03',1),(8,'Khẩu trang y tế',3,3,'hộp',50,10,'Khẩu trang dùng cho nhân viên','2025-07-14 09:18:03','2025-07-15 13:18:47',1),(9,'abc',1,1,'Cái',6,2,'','2025-07-15 15:12:09','2025-07-15 15:12:09',1);
  ...
  INSERT INTO `inventory_receipt` VALUES (1,'2025-06-20 09:00:00',1,7,'Nhập dầu massage, mặt nạ, tinh dầu','2025-07-14 09:18:03'),(2,'2025-06-21 10:00:00',2,7,'Nhập khăn spa, bộ dụng cụ nail','2025-07-14 09:18:03'),(3,'2025-06-22 11:00:00',3,7,'Nhập găng tay, bông tẩy trang, khẩu trang','2025-07-14 09:18:03');
  ...
  INSERT INTO `remember_me_tokens` VALUES (11,'quangkhoa5112@5dulieu.com','123456789','0cb51cb5-2380-4033-acdc-f3cd9fa385ce','2025-07-06 09:36:14','2025-06-06 09:36:13'),(24,'xapymabo@mailinator.com','A123456a@','aae04773-83ea-47ae-b622-9712d48c53f8','2025-07-07 08:05:55','2025-06-07 08:05:54'),(97,'therapist@beautyzone.com','123456','fc4ac81a-adca-4486-b47d-1ecb4d2a1a0b','2025-07-14 17:58:55','2025-06-14 17:58:55'),(137,'admin@beautyzone.com','123456','20bc9af0-032b-4a4e-ade7-034ee9d2e80b','2025-07-16 20:52:51','2025-06-16 20:52:51'),(149,'khoatqhe150834@fpt.edu.vn','123456','8bb29688-a91f-4ff6-b85f-6b0fcee17e56','2025-07-17 20:17:45','2025-06-17 20:17:44'),(169,'khoatqhe150834@gmail.com','123456','00458c2a-e7b6-4ccb-9414-41f99596f080','2025-07-22 20:04:06','2025-06-22 20:04:06'),(184,'manager@beautyzone.com','123456','3f1c04c9-c2b9-4f1b-adbc-6ba1df21e36f','2025-08-14 15:13:52','2025-07-15 22:13:51'),(185,'inventory@beautyzone.com','123456','4f10f59e-c112-4e66-a658-050a688da1db','2025-08-14 15:14:44','2025-07-15 22:14:43');
  ...
  INSERT INTO `supplier` VALUES (1,'Công ty TNHH Mỹ Phẩm ABC','SĐT: 0901234567, Email: abc@mypham.com',1),(2,'Công ty Dụng Cụ Spa XYZ','SĐT: 0912345678, Email: xyz@dungcuspa.com',1),(3,'Công ty Vật Tư Y Tế DEF','SĐT: 0933333333, Email: def@yt.com',0);
  ...
  -- Dump completed on 2025-07-15 23:26:38
