...
public class ImageUploadUtil {
    ...
    public static ValidationResult validateFile(Part filePart) {
        ...
        if (fileName != null) {
            ...
            if (!ALLOWED_EXTENSIONS.contains(extension)) {
                result.addError("Invalid file extension. Only " + String.join(", ", ALLOWED_EXTENSIONS) + " are allowed");
            }
        } else {
    ...
    public static ValidationResult validateImageDimensions(InputStream imageStream) {
        ...
        try {
            ...
            if (image.getWidth() < MIN_IMAGE_WIDTH || image.getHeight() < MIN_IMAGE_HEIGHT) {
                result.addError("Image dimensions must be at least " + MIN_IMAGE_WIDTH + "x" + MIN_IMAGE_HEIGHT + " pixels");
            }
    ...
    public static class ProcessedImageResult {
        ...
        // Getters and setters
        public String getFullSizeUrl() { return fullSizeUrl; }
        public void setFullSizeUrl(String fullSizeUrl) { this.fullSizeUrl = fullSizeUrl; }
