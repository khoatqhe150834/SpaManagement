...
<div class="form-container">
    <c:choose>
        <c:when test="${empty promotion}">
            <div class="alert alert-danger text-center">Không tìm thấy khuyến mãi hoặc dữ liệu không hợp lệ.</div>
            <a href="${pageContext.request.contextPath}/promotion/list" class="btn btn-secondary btn-lg btn-block mt-2">Quay lại danh sách</a>
        </c:when>
        <c:otherwise>
