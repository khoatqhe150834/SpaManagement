...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/promotion/create" method="post" novalidate>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control ${not empty errors.title ? 'is-invalid' : ''}" id="title" name="title" required maxlength="100" value="${not empty promotionInput.title ? promotionInput.title : ''}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control ${not empty errors.promotionCode ? 'is-invalid' : ''}" id="promotionCode" name="promotionCode" required maxlength="20" value="${not empty promotionInput.promotionCode ? promotionInput.promotionCode : ''}">
            <div class="error-text">${errors.promotionCode}</div>
        </div>
        <!-- Description -->
        <div class="form-group">
            <label class="form-label" for="description">Description <span class="text-danger">*</span></label>
            <textarea class="form-control ${not empty errors.description ? 'is-invalid' : ''}" id="description" name="description" rows="3" required>${not empty promotionInput.description ? promotionInput.description : ''}</textarea>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control ${not empty errors.discountValue ? 'is-invalid' : ''}" id="discountValue" name="discountValue" required min="0" step="0.01" value="${not empty promotionInput.discountValue ? promotionInput.discountValue : ''}">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="date" class="form-control ${not empty errors.startDate ? 'is-invalid' : ''}" id="startDate" name="startDate" required value="${promotionInput.startDate}">
                <div class="error-text">${errors.startDate}</div>
            </div>
            <div class="form-group col-md-6">
                <label class="form-label" for="endDate">End Date <span class="text-danger">*</span></label>
                <input type="date" class="form-control ${not empty errors.endDate ? 'is-invalid' : ''}" id="endDate" name="endDate" required value="${promotionInput.endDate}">
