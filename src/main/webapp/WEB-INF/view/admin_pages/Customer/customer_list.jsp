                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                                    ...
                                                    <c:if test="${customer.isActive}">
                                                        ...
                                                        <a href="#" onclick="return confirmAction('${deactivateUrl}', 'Bạn có chắc chắn muốn vô hiệu hóa khách hàng này?');" class="bg-warning-focus bg-hover-warning-200 text-warning-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" title="Vô hiệu hóa">
                                                    ...
                                                    <c:if test="${not customer.isActive}">
                                                        ...
                                                        <a href="#" onclick="return confirmAction('${activateUrl}', 'Bạn có chắc chắn muốn kích hoạt khách hàng này?');" class="bg-success-focus bg-hover-success-200 text-success-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" title="Kích hoạt">
