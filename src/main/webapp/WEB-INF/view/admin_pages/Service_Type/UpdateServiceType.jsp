                                    ...
                                    <form action="servicetype" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-20">
                                            ...
                                            <div class="d-flex gap-3 align-items-center">
                                                ...
                                                <div id="imagePreview"
                                                     class="${empty stype.imageUrl ? 'd-none' : ''}">
                                                    <img src="${stype.imageUrl}" alt="Preview"
                                                         class="w-100-px h-100-px rounded" id="previewImg"
                ...
                if (nameValid && descValid && imageValid) {
                    ...
                    checkNameDuplicate(nameValue, function (isDuplicate, msg) {
                        if (isDuplicate) {
                            ...
                            $('#nameError').text('Tên hợp lệ').css('color', 'green');
