...
<head>
    ...
    <meta charset="UTF-8">
    <title>Thêm Đánh Giá Dịch Vụ</title>
</head>
<body>
...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Thêm Đánh Giá Dịch Vụ</h6>
                ...
                <div class="mb-20">
                    ...
                    <select name="appointment_id" class="form-control radius-8" required>
                        <c:forEach var="a" items="${appointments}">
                            <option value="${a.appointmentId}">#${a.appointmentId} - ${a.startTime}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="mb-20">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-8">Rating</label>
                    <input type="number" name="rating" class="form-control radius-8" min="1" max="5" required />
                </div>
                <div class="mb-20">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-8">Tiêu đề</label>
                    <input type="text" name="title" class="form-control radius-8" maxlength="100" required />
                </div>
                <div class="mb-20">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-8">Nội dung</label>
                    <textarea name="comment" class="form-control radius-8" rows="4" maxlength="500" required></textarea>
                </div>
