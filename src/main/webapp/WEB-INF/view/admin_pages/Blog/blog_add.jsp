    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-white min-h-screen transition-all">
        ...
        <div class="p-6 bg-spa-cream min-h-screen">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <a href="${pageContext.request.contextPath}${rolePrefix}/blog" 
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <form action="${pageContext.request.contextPath}${rolePrefix}/blog?action=add" method="post" enctype="multipart/form-data" class="space-y-6" id="blogAddForm" novalidate>
                        <!-- Title -->
                        <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function checkTitleDuplicate(title) {
                ...
                const resp = await fetch(`${pageContext.request.contextPath}${rolePrefix}/blog?action=checkTitle&title=` + encodeURIComponent(title.trim()));
