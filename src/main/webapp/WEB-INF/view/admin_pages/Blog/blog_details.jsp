                ...
                <div class="col-lg-8">
                    <div class="card p-0 radius-12 overflow-hidden">
                        <div class="card-body p-0">
                            <img src="${pageContext.request.contextPath}/assets/admin/images/blog/blog-details.png" alt="" class="w-100 h-100 object-fit-cover">                        
                            <div class="p-32">
                        ...
                        <div class="card-body p-24">
                            <div class="comment-list d-flex flex-column">
                                <div class="comment-list__item">
                                    <div class="d-flex align-items-start gap-16">
                                        <div class="flex-shrink-0">
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/user-list/user-list1.png" alt="" class="w-60-px h-60-px rounded-circle object-fit-cover">
                                        </div>
                                ...
                                <div class="comment-list__item ms--48">
                                    <div class="d-flex align-items-start gap-16">
                                        <div class="flex-shrink-0">
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/user-list/user-list2.png" alt="" class="w-60-px h-60-px rounded-circle object-fit-cover">
                                        </div>
                                        <div class="flex-grow-1 border-bottom pb-40 mb-40 border-dashed">
                                ...
                                <div class="comment-list__item ms--48">
                                    <div class="d-flex align-items-start gap-16">
                                        <div class="flex-shrink-0">
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/user-list/user-list3.png" alt="" class="w-60-px h-60-px rounded-circle object-fit-cover">
                                        </div>
                                        <div class="flex-grow-1 border-bottom pb-40 mb-40 border-dashed">
                                ...
                                <div class="comment-list__item">
                                    <div class="d-flex align-items-start gap-16">
                                        <div class="flex-shrink-0">
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/user-list/user-list4.png" alt="" class="w-60-px h-60-px rounded-circle object-fit-cover">
                                        </div>
                                        <div class="flex-grow-1 border-bottom pb-40 mb-40 border-dashed">
                                ...
                                <div class="comment-list__item ms--48">
                                    <div class="d-flex align-items-start gap-16">
                                        <div class="flex-shrink-0">
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/user-list/user-list6.png" alt="" class="w-60-px h-60-px rounded-circle object-fit-cover">
                                        </div>
