                                ...
                                <form action="service" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="mb-32">
                                        <div class="d-flex align-items-center gap-3 mb-20">
                                            <div
                                                class="bg-primary-50 d-flex align-items-center justify-content-center w-40-px h-40-px radius-12">
                                        ...
                                        <div class="mb-20">
                                            <label class="form-label fw-semibold text-primary-light text-sm mb-8">Loại
                                                dịch vụ</label>
                                            <input type="text" class="form-control radius-8"
                                                value="${service.serviceTypeId.name}" readonly>
                                        ...
                                        <div class="mb-20">
                                            ...
                                            <input type="text" name="name" class="form-control radius-8" id="name"
                                                placeholder="Nhập tên dịch vụ" value="${service.name}" required />
                                        ...
                                        <div class="mb-20">
                                            <label for="description"
                                                class="form-label fw-semibold text-primary-light text-sm mb-8">Mô
                                                tả</label>
                                    ...
                                    <div class="mb-32">
                                        <div class="d-flex align-items-center gap-3 mb-20">
                                            <div
                                                class="bg-success-50 d-flex align-items-center justify-content-center w-40-px h-40-px radius-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-20">
                                                    <label for="price"
                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">Giá</label>
                                                    <div class="input-group">
                                                        <input type="number" name="price"
                                                            class="form-control radius-8-start" id="price"
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-20">
                                                    <label for="duration_minutes"
                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">Thời
                                                        lượng</label>
                                                    <div class="input-group">
                                                        <input type="number" name="duration_minutes"
                                                            class="form-control radius-8-start" id="duration_minutes"
                                                ...
                                                <div class="mb-20">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" name="buffer_time_after_minutes"
                                                            class="form-control radius-8-start"
                                                            id="buffer_time_after_minutes"
                                    ...
                                    <div class="mb-32">
                                        <div class="d-flex align-items-center gap-3 mb-20">
                                            <div
                                                class="bg-info-50 d-flex align-items-center justify-content-center w-40-px h-40-px radius-12">
                                                <iconify-icon icon="solar:gallery-wide-outline"
                                        ...
                                        <div class="upload-image-wrapper d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            <label
                                                ...
                                                <input id="upload-file-multiple" type="file" name="images" multiple
                                                    hidden>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-32">
                                        <div class="d-flex align-items-center gap-3 mb-20">
                                            <div
                                                class="bg-warning-50 d-flex align-items-center justify-content-center w-40-px h-40-px radius-12">
                                                <iconify-icon icon="solar:settings-outline"
                                                    class="text-warning text-xl"></iconify-icon>
                                            </div>
                                        ...
                                        <div class="list-group">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted d-block mt-1">Dịch vụ sẽ hiển thị và có thể
                                                        được đặt lịch.</small>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted d-block mt-1">Cho phép khách hàng tự đặt
                                                        lịch cho dịch vụ này qua website.</small>
                                                </div>
                                                <div class="form-switch switch-primary">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        name="bookable_online" id="bookable_online"
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted d-block mt-1">Yêu cầu khách hàng phải được
                                                        tư vấn trước khi đặt dịch vụ.</small>
                                                </div>
                                                <div class="form-switch switch-primary">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-3">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary border border-primary-600 text-md px-40 py-12 radius-8">Cập
                                            nhật</button>
                                    </div>
                                </form>
                            </div>
