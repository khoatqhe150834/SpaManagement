...
<head>
  ...
  <title>
    <c:choose>
      <c:when test="${formAction eq 'edit'}">Sửa phiếu xuất</c:when>
      <c:otherwise>Tạo phiếu xuất mới</c:otherwise>
    </c:choose>
  </title>
  <!-- Tailwind CSS -->
    ...
    <form method="post" action="/inventory-manager/issue/create">
      ...
      <div class="bg-white rounded-2xl shadow-lg mb-6">
        <div class="p-6 border-b border-gray-200">
          <h3 class="text-xl font-semibold text-spa-dark flex items-center gap-2">
            <i data-lucide="file-minus" class="h-6 w-6 text-primary"></i>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <i data-lucide="calendar-check" class="h-5 w-5 text-gray-400"></i>
                </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <select name="status" required class="block w-full pl-10 pr-8 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors appearance-none">
                  <option value="PENDING" <c:if test="${issue.status == 'PENDING'}">selected</c:if>>Chờ phê duyệt</option>
                </select>
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                  <i data-lucide="chevron-down" class="h-4 w-4 text-gray-400"></i>
                </div>
          ...
          <div class="space-y-2 mt-6">
            ...
            <div class="relative">
              ...
              <textarea name="note" rows="3" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors resize-none" placeholder="Ghi chú về phiếu xuất...">${issue.note}</textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg mb-6">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
          <div>
            <h3 class="text-xl font-semibold text-spa-dark flex items-center gap-2">
              <i data-lucide="package-minus" class="h-6 w-6 text-primary"></i>
              Chi tiết phiếu xuất
            </h3>
            <p class="text-gray-600 mt-1">Danh sách vật tư xuất kho</p>
          </div>
          <button type="button" onclick="addIssueDetail()" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm">
              ...
              <tr>
                ...
                <th class="px-4 py-3 text-center">Số lượng xuất</th>
                  ...
                  <c:forEach var="detail" items="${issueDetails}" varStatus="status">
                    <tr class="border-b hover:bg-gray-50">
                      ...
                      <td class="px-4 py-3 text-center">
                        <button type="button" onclick="removeIssueDetail(this)" class="p-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-full transition-colors">
              ...
              <tr>
                <td colspan="3" class="px-4 py-3 text-right font-semibold text-spa-dark">Tổng giá trị:</td>
      ...
      <div class="flex flex-col sm:flex-row gap-3">
        ...
        <a href="../issue" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition-colors">
