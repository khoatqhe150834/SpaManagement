...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 min-h-screen transition-all">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
      ...
      <a href="issue/create" class="inline-flex items-center gap-2 h-10 px-4 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors">
                ...
                <td class="px-6 py-4">
                 ...
                 <td class="px-6 py-4 text-center">
                    <div class="flex items-center justify-center gap-2">
                      ...
                      <!-- Nút xóa (chỉ hiển thị nếu owner == true) -->
                      <c:if test="${receipt.owner}">
                        <form action="issue/delete" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn xóa phiếu này không?');">
                          <input type="hidden" name="id" value="${receipt.inventoryIssueId}" />
                          <button type="submit"
                                  class="p-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-full"
