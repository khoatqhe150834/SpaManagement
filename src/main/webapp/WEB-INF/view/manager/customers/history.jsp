<%-- 
    ...
    Created on : Manager Customer History
...
<head>
    ...
    <title>Lịch Sử Sử Dụng - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Lịch Sử Sử Dụng</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Lịch Sử Sử Dụng</li>
            </ul>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Trang quản lý lịch sử sử dụng dịch vụ của khách hàng</p>
                <p>TODO: Implement customer service usage history</p>
            </div>
        </div>
    </div>
