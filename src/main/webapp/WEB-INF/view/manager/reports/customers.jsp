<%-- 
    ...
    Created on : Manager Customer Reports
...
<head>
    ...
    <title>Thống Kê Khách Hàng - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Thống Kê Khách Hàng</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Thống Kê Khách Hàng</li>
            </ul>
        </div>

        <div class="card">
            <div class="card-body">
                <h4>Thống Kê Khách Hàng Mới</h4>
                <p>Trang thống kê khách hàng mới và phân tích xu hướng</p>
                <p>TODO: Implement customer statistics</p>
            </div>
        </div>
    </div>
