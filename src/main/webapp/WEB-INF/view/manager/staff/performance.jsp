<%-- 
    Document   : performance.jsp
    Created on : Manager Staff Performance
...
<head>
    ...
    <title>Thống Kê Hiệu Suất - Manager Dashboard</title>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Thống Kê Hiệu Suất</li>
            </ul>
        </div>

        <div class="card">
            <div class="card-body">
                <h4>Thống Kê Hiệu Suất Nhân Viên</h4>
                <p>Trang thống kê hiệu suất làm việc của nhân viên</p>
                <p>TODO: Implement performance statistics</p>
            </div>
        </div>
    </div>
