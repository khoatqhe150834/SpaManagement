        ...
        <div class="bg-white rounded-lg max-w-2xl w-full h-[90vh] flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto" id="cartContent">
                ...
                <div id="emptyCartMessage" class="text-center py-12 px-6">
                    ...
                    <button onclick="closeCart()" class="px-6 py-3 bg-[#D4AF37] text-white rounded-lg hover:bg-[#B8941F] transition-colors font-semibold">
                        Khám phá dịch vụ
                    </button>
                </div>
            ...
            <div id="cartFooter" class="border-t p-6 flex-shrink-0 bg-white" style="display: none;">
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button onclick="proceedToCheckout()" class="flex-2 flex items-center justify-center px-6 py-3 bg-[#D4AF37] text-white rounded-lg hover:bg-[#B8941F] transition-colors font-semibold">
