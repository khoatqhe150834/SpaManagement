            ...
            <div class="bg-white shadow-sm">
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm text-gray-500" id="step-indicator">
                            Bước 1 / 5
                        </div>
                    </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <p class="text-gray-600 mb-6">
                                Chọn các dịch vụ từ giỏ hàng của bạn để đặt lịch (tối đa 6 dịch vụ mỗi lần)
                            </p>
                        </div>
                        ...
                        <div id="empty-cart-message" class="bg-white rounded-lg shadow-lg p-12 text-center" style="display: none;">
                            ...
                            <button onclick="window.location.href='${pageContext.request.contextPath}/services'" class="px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors font-semibold">
                        ...
                        <div id="cart-items-container" class="bg-white rounded-lg shadow-lg p-6">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="text-sm text-gray-600">
                                    Đã chọn: <span id="selected-count">0</span>/6
                                </div>
                            </div>
                            ...
                            <div id="service-limit-warning" class="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg" style="display: none;">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-yellow-800 text-sm font-medium">
                                        Bạn chỉ có thể đặt lịch tối đa 6 dịch vụ mỗi lần.
                                    </p>
                                </div>
                            </div>

                            <div id="cart-services-grid" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div id="selected-summary" class="bg-white rounded-lg shadow-lg p-6" style="display: none;">
                            ...
                            <div id="selected-services-list" class="space-y-4">
                                <!-- Selected services will be populated here -->
                            </div>
                            <div id="selected-totals" class="border-t pt-4 mt-4">
                ...
                <div id="step-2" class="step-content" style="display: none;">
                    <div class="space-y-8">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div id="step2-services-list" class="space-y-4">
                                <!-- Selected services summary -->
                            </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <div id="selected-time-display" style="display: none;">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <button id="change-time-btn" class="p-2 border border-primary text-primary rounded-lg hover:bg-spa-cream transition-colors" title="Thay đổi thời gian">
                ...
                <div id="step-3" class="step-content" style="display: none;">
                    <div class="space-y-8">
                        ...
                        <!-- Selected Services & Time Summary -->
                        <div class="bg-white rounded-lg shadow-lg p-6">
                            <h3 class="text-lg font-semibold text-spa-dark mb-4">Thông tin đã chọn</h3>
                            <div id="step3-summary" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div id="therapists-grid" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div id="step-4" class="step-content" style="display: none;">
                    <div class="space-y-8">
                        ...
                        <div id="guest-info-form" class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="guest-name-error error-message" style="display: none;"></div>
                                </div>
                                <div>
                                    ...
                                    <div class="guest-email-error error-message" style="display: none;"></div>
                                </div>
                                <div>
                                    ...
                                    <div class="guest-phone-error error-message" style="display: none;"></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Địa chỉ thanh toán *</label>
                                    ...
                                    <div class="guest-address-error error-message" style="display: none;"></div>
                                </div>
                        ...
                        <div id="user-info-display" class="bg-white rounded-lg shadow-lg p-6" style="display: none;">
                            ...
                            <div id="user-details" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div id="step4-booking-summary" class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div id="step4-summary-content" class="space-y-4">
                ...
                <div id="step-5" class="step-content" style="display: none;">
                    <div class="space-y-8">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div id="step5-booking-review" class="space-y-4">
                        ...
                        <div id="qr-payment-section" class="bg-white rounded-lg shadow-lg p-6 text-center" style="display: none;">
                            ...
                            <p class="text-sm text-gray-600 mb-4" id="qr-instructions">
                ...
                <div id="step-6" class="step-content" style="display: none;">
                    <div class="text-center py-12">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto mb-8">
                            ...
                            <div class="text-3xl font-bold text-primary mb-4" id="booking-code">
                                <!-- Booking code will be generated -->
                            </div>
                            ...
                            <!-- Booking Details -->
                            <div id="success-booking-details" class="text-left space-y-2 border-t pt-4">
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 p-6">
                        ...
                        <div id="calendar-time-slots" style="display: none;">
                            ...
                            <div id="time-slots-grid" class="grid grid-cols-3 gap-3 max-h-80 overflow-y-auto">
                            ...
                            <div id="confirm-time-section" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg" style="display: none;">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button id="confirm-time-btn" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors">
                                        Xác nhận
                                    </button>
                                </div>
                            </div>
