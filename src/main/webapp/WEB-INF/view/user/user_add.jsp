...
<head>
    ...
    <title>Thêm Nhân Viên Mới - Dashboard</title>
        ...
        <main class="flex-1 py-12 lg:py-20 ml-64">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-wrap items-center gap-2 mb-8 text-gray-500 text-sm">
                    ...
                    <span>-</span>
                    <span class="text-primary font-semibold">Thêm nhân viên mới</span>
                </div>
                ...
                <c:if test="${not empty error}">
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 rounded-lg" role="alert">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium">Lỗi khi thêm nhân viên:</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div class="bg-gradient-to-r from-primary to-primary-dark p-6">
                        ...
                        <p class="text-white/90 mt-2">Nhập thông tin đầy đủ để tạo tài khoản nhân viên mới</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="gender" name="gender" class="form-input">
                                        <option value="UNKNOWN" ${userInput.gender[0] == 'UNKNOWN' ? 'selected' : ''}>Không xác định</option>
                                        <option value="MALE" ${userInput.gender[0] == 'MALE' ? 'selected' : ''}>Nam</option>
                                        <option value="FEMALE" ${userInput.gender[0] == 'FEMALE' ? 'selected' : ''}>Nữ</option>
                                        <option value="OTHER" ${userInput.gender[0] == 'OTHER' ? 'selected' : ''}>Khác</option>
                                    </select>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    <label for="password" class="form-label">
                                        Mật khẩu <span class="form-required">*</span>
                                    </label>
                                    <input type="password" 
                                           id="password" 
                                           name="password" 
                            ...
                            <div>
                                ...
                                <select id="roleId" name="roleId" class="form-input ${errors.roleId != null ? 'is-invalid' : ''}" required>
                                    ...
                                    <c:if test="${currentUser.roleId == 1}">
                                        <option value="2" ${userInput.roleId[0] == '2' ? 'selected' : ''}>Manager</option>
                                        <option value="3" ${userInput.roleId[0] == '3' ? 'selected' : ''}>Therapist</option>
                                        <option value="4" ${userInput.roleId[0] == '4' ? 'selected' : ''}>Receptionist</option>
                                        <option value="6" ${userInput.roleId[0] == '6' ? 'selected' : ''}>Marketing</option>
                                        <option value="7" ${userInput.roleId[0] == '7' ? 'selected' : ''}>Inventory Manager</option>
                                    </c:if>
                                ...
                                <div class="text-sm text-gray-500 mt-1">
                                    <i data-lucide="info" class="w-4 h-4 inline mr-1"></i>
                                    Vai trò quyết định quyền hạn truy cập của nhân viên trong hệ thống
                                </div>
                            </div>
                        </div>
