...
public class MenuService {
  ...
  public static List<MenuItem> getAdminMenuItems(String contextPath) {
    ...
    menuItems.add(new MenuItem("Bảng điều khiển", contextPath + "/admin/dashboard", "fa fa-dashboard"));
    ...
    menuItems.add(new MenuItem("Báo cáo hệ thống", contextPath + "/admin/reports", "fa fa-chart-bar"));
  ...
  public static List<MenuItem> getManagerMenuItems(String contextPath) {
    ...
    menuItems.add(new MenuItem("Quản lý dịch vụ", contextPath + "/admin/services", "fa fa-tasks"));
    menuItems.add(new MenuItem("Báo cáo doanh thu", contextPath + "/admin/revenue-reports", "fa fa-chart-line"));
  ...
  public static List<MenuItem> getTherapistMenuItems(String contextPath) {
    ...
    menuItems.add(new MenuItem("Dịch vụ thực hiện", contextPath + "/therapist/services", "fa fa-spa"));
    menuItems.add(new MenuItem("Báo cáo hiệu suất", contextPath + "/therapist/performance", "fa fa-chart-bar"));
    menuItems.add(new MenuItem("Cài đặt", contextPath + "/profile/settings", "fa fa-cog"));
    menuItems.add(new MenuItem()); // Divider
    menuItems.add(new MenuItem("Đăng xuất", contextPath + "/logout", "fa fa-sign-out"));
  ...
  public static List<MenuItem> getReceptionistMenuItems(String contextPath) {
    ...
    menuItems.add(new MenuItem("Thanh toán", contextPath + "/receptionist/payments", "fa fa-money"));
