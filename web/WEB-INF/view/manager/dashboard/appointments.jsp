<%-- 
    Document   : appointments.jsp
    Created on : Manager Dashboard Appointments
...
<head>
    ...
    <title>Thống Kê Đặt Lịch - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Thống Kê Đặt Lịch</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Thống Kê Đặt Lịch</li>
            </ul>
        </div>

        <div class="card">
            <div class="card-body">
                <h4>Thống Kê Đặt Lịch Hẹn</h4>
                <p>Trang thống kê các lịch hẹn và xu hướng đặt lịch</p>
                <p>TODO: Implement appointment statistics</p>
            </div>
        </div>
    </div>
