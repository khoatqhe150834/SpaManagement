<%-- 
    ...
    Created on : Manager Service Packages
...
<head>
    ...
    <title>Gói Dịch Vụ - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Gói Dịch Vụ</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Gói Dịch Vụ</li>
            </ul>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Trang quản lý các gói dịch vụ spa</p>
                <p>TODO: Implement service packages management</p>
            </div>
        </div>
    </div>
