<%-- 
    ...
    Created on : Manager Service Pricing
...
<head>
    ...
    <title>Giá & Khuyến Mãi - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Giá & Khuyến Mãi</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Giá & Khuyến Mãi</li>
            </ul>
        </div>

        <div class="card">
            <div class="card-body">
                <h4>Quản Lý Giá & Khuyến Mãi</h4>
                <p>Trang quản lý giá dịch vụ và các chương trình khuyến mãi</p>
                <p>TODO: Implement pricing and promotions management</p>
            </div>
        </div>
    </div>
