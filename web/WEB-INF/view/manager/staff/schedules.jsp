<%-- 
    Document   : schedules.jsp
    Created on : Manager Staff Schedules
...
<head>
    ...
    <title>Lịch Làm Việc - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Lịch Làm Việc</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Lịch Làm Việc</li>
            </ul>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Trang quản lý lịch làm việc của nhân viên</p>
                <p>TODO: Implement work schedules management</p>
            </div>
        </div>
    </div>
