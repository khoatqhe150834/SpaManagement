...
<head>
    ...
    <title>Danh Sách Nhân Viên - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        ...
        <div class="card">
            <div class="card-body">
                <h4>Danh Sách Nhân Viên & Chi Tiết</h4>
                <p>Trang quản lý danh sách nhân viên và thông tin chi tiết</p>
                <p>TODO: Implement staff list and details management</p>
            </div>
        </div>
    </div>
