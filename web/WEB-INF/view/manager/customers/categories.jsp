<%-- 
    ...
    Created on : Manager Customer Categories
...
<head>
    ...
    <title>Phân Loại Khách Hàng - Manager Dashboard</title>
...
<body>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Phân Loại Khách Hàng</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Phân Loại Khách Hàng</li>
            </ul>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Trang quản lý phân loại khách hàng (VIP, Thường, Mới)</p>
                <p>TODO: Implement customer categorization functionality</p>
            </div>
        </div>
    </div>
