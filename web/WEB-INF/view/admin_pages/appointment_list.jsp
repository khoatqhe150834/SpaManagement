<%-- 
    ...
    Created on : Jun 1, 2025, 10:26:47 PM
    Author     : ADMIN
--%>
...
<!-- Mirrored from wowdash.wowtheme7.com/demo/invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Feb 2025 04:43:43 GMT -->
<head>
  <meta charset="UTF-8">
    ...
    <div class="card">
      <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
          ...
          <a href="invoice-add.html" class="btn btn-sm btn-primary-600"><i class="ri-add-line"></i> Create Invoice</a>
        </div>
      </div>
      <div class="card-body">
...
<!-- Mirrored from wowdash.wowtheme7.com/demo/invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Feb 2025 04:43:48 GMT -->
</html>
