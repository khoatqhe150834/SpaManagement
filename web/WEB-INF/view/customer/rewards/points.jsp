<%-- 
    Document   : points.jsp
    Created on : Loyalty Points Management
...
<head>
    ...
    <title>Điểm Thưởng - BeautyZone Spa</title>
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Điểm Thưởng</li>
            </ul>
        </div>
        
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <h5 class="card-title mb-20">Điểm Thưởng Của Tôi</h5>
                <div class="text-center py-48">
                    <iconify-icon icon="solar:gift-outline" class="text-primary-600" style="font-size: 64px;"></iconify-icon>
                    <h6 class="text-neutral-600 mb-8 mt-3">Điểm Thưởng</h6>
