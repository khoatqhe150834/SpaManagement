<%-- 
    Document   : header
    Created on : May 25, 2025, 4:22:29 PM
    Author     : quang
--%>
        ...
        <div class="main-bar clearfix ">
            <div class="container clearfix">
                ...
                <div class="logo-header mostion">
                    <a href="index.html" class="dez-page"><img src="${pageContext.request.contextPath}/assets/home/images/logo-black.png" alt=""></a>
                </div>
                <!-- nav toggle button -->
                    ...
                    <ul class="nav navbar-nav">	
                        ...
                        <li><a href="javascript:void(0);">Pages <i class="fa fa-chevron-down"></i></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="${pageContext.request.contextPath}/login" class="dez-page">Login</a></li>
